...
class creattrainingpage7 extends StatefulWidget {
  const creattrainingpage7({Key? key}) : super(key: key);

  @override
  State<creattrainingpage7> createState() => _creattrainingpage7State();
}

class _creattrainingpage7State extends State<creattrainingpage7> {
  @override
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                      flex:6,
                      child: Text("Add a grocery or supplements for the client to buy ", style: TextStyle(color: colors().black,fontSize: 20,fontWeight: FontWeight.bold))),
                ],
              ),
            ),
