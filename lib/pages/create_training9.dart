...
class createtrainingpage9 extends StatefulWidget {
  const createtrainingpage9({Key? key}) : super(key: key);

  @override
  State<createtrainingpage9> createState() => _createtrainingpage9State();
}

class _createtrainingpage9State extends State<createtrainingpage9> {
  bool status=false;
        ...
        child: Column(
          children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        2.h.heightBox,
                        Text("Carbs\n(g)",style: TextStyle(color: colors().white,fontSize: 18),textAlign: TextAlign.center,),
                        1.h.heightBox,
                        Container(
                          ...
                          child: Icon(Icons.add,color: colors().splashscreenbacground,),
                        ),
                        1.h.heightBox,
                        ...
                        Container(
                          ...
                          child: Icon(Icons.horizontal_rule,color: colors().splashscreenbacground,),
                        ),
            ...
            Container(
              ...
              child: Center(child: Text("How to cook it ' optional '",style: TextStyle(color: colors().white,fontSize: 22),))
            ),
            Padding(
