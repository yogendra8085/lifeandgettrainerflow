...
class totalbalancepage extends StatefulWidget {
  const totalbalancepage({Key? key}) : super(key: key);

  @override
  State<totalbalancepage> createState() => _totalbalancepageState();
}
      ...
      appBar:  AppBar(
        ...
        title: Row(
          ...
          children: [
            ...
            Padding(
              padding:  EdgeInsets.symmetric(horizontal: 2.w,vertical: 1.h),
              child: Text("Total Balance",style: TextStyle(color: colors().white,fontSize: 23),),
            )
          ],),),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            3.h.heightBox,
            Text('Total Balance',style: TextStyle(color: colors().black,fontSize: 22,fontWeight: FontWeight.bold),),
            2.h.heightBox,
            Align(
